...
const Content = () => {
  return (
    <div className="h-screen w-screen  flex justify-center 	items-center flex-col">
      ...
      <div className=" bg-slate-400  w-3/4 h-32 rounded-md">
        <div className=" w-full h-20 bg-slate-400 p-3 rounded-md gap-2 flex justify-between ">
          <div className="w-2/6">
            <h2 className="w-full text-lg font-bold text-slate-600 text-left">
              Amount
            </h2>
          ...
          <div className="w-2/6">
            ...
            <select className="w-full font-bold  text-slate-600">
        ...
        <div className="flex justify-end p-3">
          <button className="w-17 h-6 bg-gray-50 text-black rounded-md">
            Convert
          </button>
        </div>
      </div>
